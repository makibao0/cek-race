...
export default function RaceResult({ data, name }: { data: RaceData; name: string }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div ref={resultRef} className="mt-4 relative overflow-hidden rounded-2xl bg-slate-900 border border-white/10 p-8 shadow-2xl transition-all duration-500 hover:shadow-purple-500/10 hover:border-purple-500/30 group">
        {/* Decorative blurs */}
